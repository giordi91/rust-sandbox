...
pub struct Renderer {
    ...
    textures: Textures<ImguiBindGroup>,
...
impl Renderer {
    ...
    pub fn new(
        ...
        let vs_bytes = include_bytes!("../../../resources/imgui/imgui.vert.spv");
        let fs_bytes = include_bytes!("../../../resources/imgui/imgui.frag.spv");
    ...
    pub fn upload_texture(
        ...
        let texture = ImguiBindGroup::new(texture, &self.texture_layout, device);
